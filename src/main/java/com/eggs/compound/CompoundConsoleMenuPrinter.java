...
@Component
@Qualifier("console")
public class CompoundConsoleMenuPrinter extends BaseMenuPrinter {
    
    private static final Logger logger = LoggerFactory.getLogger(CompoundConsoleMenuPrinter.class);
    ...
    @Autowired
    public CompoundConsoleMenuPrinter(@Qualifier("Peti")MenuRepository menuRepository) {
